...
1. **场景一**：记录事件日志，用于审计和调试的基础应用
2. **场景二**：与其他节点配合使用
3. **场景三**：复杂业务逻辑处理

## 注意事项

1. 确保 `node_type` 字段值为 `log`
2. 配置字段需符合 Schema 定义
3. 建议启用错误处理和重试机制
