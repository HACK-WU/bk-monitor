...
class Host(BaseNode):
    ...
    def __init__(self, attrs: dict | None = None, **kwargs):
        ...
        参数:
            attrs: 原始属性字典，若为None则初始化为空字典
            **kwargs: 任意额外关键字参数，将合并到attrs中
        ...
        # 主要必须字段的默认值补全
        # 将bk_host_innerip映射为ip字段
        # srv_status优先作为bk_state来源，降级使用原bk_state
        ...
        # 拓扑链接结构转换
        # 将topo_link中的节点列表转换为TopoNode对象实例
