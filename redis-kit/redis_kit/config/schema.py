...
class RedisKitConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "RedisKitConfig":
        ...
        for backend_name, backend_data in data.get("backends", {}).items():
            if isinstance(backend_data, dict):
                backends[backend_name] = BackendConfig(name=backend_name, **backend_data)
        ...
        return cls(
            ...
            circuit_breaker_recovery_timeout=data.get("circuit_breaker_recovery_timeout", 30.0),
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "backends": {name: vars(backend) for name, backend in self.backends.items()},
