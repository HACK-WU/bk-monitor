...
class YamlConfigLoader(ConfigLoader):
    ...
    def load(self) -> RedisKitConfig:
        ...
        try:
            ...
            raise ConfigurationError("pyyaml is required for YAML config. Install with: pip install pyyaml")
...
class EnvConfigLoader(ConfigLoader):
    ...
    def _parse_node_config(self, field_path: str, value: str, config: Dict[str, Any]) -> None:
        """解析节点配置"""
    ...
    def _parse_backend_config(self, field_path: str, value: str, config: Dict[str, Any]) -> None:
        """解析后端配置"""
        parts = field_path.split("_", 1)
        if len(parts) != 2:
            return
    ...
    def _parse_general_config(self, field_path: str, value: str, config: Dict[str, Any]) -> None:
        """解析通用配置"""
