...
class SimpleYearRoundAlgorithm(RangeRatioAlgorithm):
    ...
    # 下降告警模板
    floor_desc_tpl: str = "decreased by more than {floor}% compared to same time last week (history: {floor_history_value})"
    
    # 上升告警模板
    ceil_desc_tpl: str = "increased by more than {ceil}% compared to same time last week (history: {ceil_history_value})"
