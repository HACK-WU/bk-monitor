...
from tsdetect.core.exceptions import InvalidAlgorithmConfig, SDKError
...
class BaseIntelligentAlgorithm(RangeRatioAlgorithm, ABC):
    ...
    def __init__(
        ...
        sdk_client: Optional[ISDKClient] = None,
        **kwargs
    ):
        """
        初始化智能检测算法
    ...
    def _generate_sdk_params(self) -> Dict[str, Any]:
        ...
        return {
            "predict_args": {
                key.lstrip("$"): value for key, value in args.items()
            }
        }
...
def create_intelligent_algorithm(
    ...
    **kwargs
    ...
    return SimpleIntelligentAlgorithm(
        config=config,
